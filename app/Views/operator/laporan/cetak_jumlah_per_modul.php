...
<head>
    ...
    <title>Rekap Jumlah Berkas per Modul - BPDAS Barito</title>
    <style>
        body {
...
<body>
    ...
    <h1>Rekap Jumlah Berkas per Modul</h1>
            ...
            <tbody>
                <?php $no = 1; foreach ($rekap_modul as $rm): ?>
                    <tr>
                        ...
                        <td class="center"><?= number_format($rm['jumlah']) ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
            <tfoot>
                <tr class="total-row">
                    ...
                    <td class="center"><?= number_format(array_sum(array_column($rekap_modul, 'jumlah'))) ?></td>
                </tr>
            </tfoot>
        </table>
    <?php else: ?>
