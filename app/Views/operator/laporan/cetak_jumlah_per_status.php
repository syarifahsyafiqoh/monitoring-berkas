...
<head>
    ...
    <title>Rekap Jumlah Berkas per Status - BPDAS Barito</title>
    <style>
        body {
...
<body>
    ...
    <h1>Rekap Jumlah Berkas per Status</h1>
        ...
        <table>
            ...
            <tfoot>
                <tr class="total-row">
                    ...
                    <td class="center"><?= number_format(array_sum(array_column($rekap_status, 'jumlah'))) ?></td>
                </tr>
            </tfoot>
        </table>
    <?php else: ?>
