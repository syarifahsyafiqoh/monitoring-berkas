...
<link href="<?= base_url('assets/css/tunjangan_kinerja/input.css') ?>" rel="stylesheet">
...
<div class="page-header-form">
    ...
    <div class="header-content">
        <h3 class="header-title">Input Tunjangan Kinerja</h3>
...
<div class="form-container">
    <div class="form-card">
        <?php helper('form'); ?>
        <?= form_open('tunjangan-kinerja/simpan', ['id' => 'formTunjanganKinerja', 'class' => 'needs-validation', 'novalidate' => true]) ?>
        ...
        <div class="form-group">
            ...
            <textarea name="uraian" 
                      class="form-control" 
                      rows="4" 
                      placeholder="Deskripsikan uraian tunjangan kinerja..." 
                      required></textarea>
        ...
        <div class="form-actions">
            <a href="<?= base_url('tunjangan-kinerja') ?>" class="btn-cancel">
...
<script src="<?= base_url('assets/js/tunjangan_kinerja/input.js') ?>"></script>
