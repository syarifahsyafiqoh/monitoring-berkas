...
<link href="<?= base_url('assets/css/tunjangan_kinerja/index.css') ?>" rel="stylesheet">
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <div class="page-info">
            <h4 class="page-title">Tunjangan Kinerja</h4>
            <p class="page-subtitle">Kelola data tunjangan kinerja pegawai</p>
        </div>
    </div>
    <div class="page-actions">
        <!-- <a href="<?= base_url('tunjangan-kinerja/export') ?>" class="btn-action btn-export">
            <i class="bi bi-file-earmark-excel"></i>
            <span>Export Excel</span>
        </a> -->
        <a href="<?= base_url('tunjangan-kinerja/input') ?>" class="btn-action btn-primary-action">
...
<!-- <div class="stats-cards-mini">
    <div class="stat-card-mini stat-primary">
        ...
        <div class="stat-mini-content">
            <p class="stat-mini-label">Total Tunjangan Kinerja</p>
            <h3 class="stat-mini-value" id="total-tk">0</h3>
        </div>
    </div>
...
<div class="data-table-card">
    ...
    <div class="table-card-body">
        <div class="table-responsive">
            <table id="table-tk" class="table custom-datatable">
                <thead>
                    <tr>
                        <th width="50">No</th>
                        <th>Uraian</th>
...
$(document).ready(function() {
    ...
    table = $('#table-tk').DataTable({
        ajax: {
            url: '<?= base_url('tunjangan-kinerja/data') ?>',
            ...
            error: function() {
                Swal.fire({
                    title: 'Gagal!',
                    text: 'Data tunjangan kinerja tidak dapat dimuat.',
                    icon: 'error',
        ...
        columns: [
            ...
            {  
                ...
                render: function(id) {
                    ...
                    html += '<a href="<?= base_url('tunjangan-kinerja/detail') ?>/' + id + '" class="btn-table-action btn-detail" title="Lihat Detail"><i class="bi bi-eye"></i></a>';
                    html += '<a href="<?= base_url('tunjangan-kinerja/edit') ?>/' + id + '" class="btn-table-action btn-edit" title="Edit Data"><i class="bi bi-pencil"></i></a>';
...
function hapusData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch('<?= base_url('tunjangan-kinerja/hapus') ?>/' + id, { 
                method: 'DELETE',
                headers: {
            ...
            .then(function(data) {
                ...
                Swal.fire({
                    title: 'Berhasil!',
                    text: 'Data tunjangan kinerja sudah dihapus.',
                    icon: 'success',
