...
<link href="<?= base_url('assets/css/honorarium/index.css') ?>" rel="stylesheet">
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <div class="page-info">
            <h4 class="page-title">Honorarium</h4>
            <p class="page-subtitle">Kelola data honorarium pegawai</p>
        </div>
    </div>
    <div class="page-actions">
        ...
        <a href="<?= base_url('honorarium/input') ?>" class="btn-action btn-primary-action">
...
<!-- <div class="stats-cards-mini">
    <div class="stat-card-mini stat-primary">
        ...
        <div class="stat-mini-content">
            <p class="stat-mini-label">Total Honorarium</p>
            <h3 class="stat-mini-value" id="total-honor">0</h3>
        </div>
    </div>
...
<div class="data-table-card">
    ...
    <div class="table-card-body">
        <div class="table-responsive">
            <table id="table-honor" class="table custom-datatable">
                <thead>
                    <tr>
                        <th width="50">No</th>
                        <th>Uraian</th>
...
$(document).ready(function() {
    ...
    table = $('#table-honor').DataTable({
        ajax: {
            url: '<?= base_url('honorarium/data') ?>',
            ...
            error: function() {
                Swal.fire({
                    title: 'Gagal!',
                    text: 'Data honorarium tidak dapat dimuat.',
                    icon: 'error',
        ...
        columns: [
            ...
            {  
                ...
                render: function(id) {
                    ...
                    html += '<a href="<?= base_url('honorarium/detail') ?>/' + id + '" class="btn-table-action btn-detail" title="Lihat Detail"><i class="bi bi-eye"></i></a>';
                    html += '<a href="<?= base_url('honorarium/edit') ?>/' + id + '" class="btn-table-action btn-edit" title="Edit Data"><i class="bi bi-pencil"></i></a>';
...
function hapusData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch('<?= base_url('honorarium/hapus') ?>/' + id, { 
                method: 'DELETE',
                headers: {
            ...
            .then(function(data) {
                ...
                Swal.fire({
                    title: 'Berhasil!',
                    text: 'Data honorarium sudah dihapus.',
                    icon: 'success',
