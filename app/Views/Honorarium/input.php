...
<link href="<?= base_url('assets/css/honorarium/input.css') ?>" rel="stylesheet">
...
<div class="page-header-form">
    ...
    <div class="header-content">
        <h3 class="header-title">Input Honorarium</h3>
...
<div class="form-container">
    <div class="form-card">
        <?php helper('form'); ?>
        <?= form_open('honorarium/simpan', ['id' => 'formHonorarium', 'class' => 'needs-validation', 'novalidate' => true]) ?>
        ...
        <div class="form-group">
            ...
            <textarea name="uraian" 
                      class="form-control" 
                      rows="4" 
                      placeholder="Deskripsikan uraian honorarium..." 
                      required></textarea>
        ...
        <div class="form-actions">
            <a href="<?= base_url('honorarium') ?>" class="btn-cancel">
...
<script src="<?= base_url('assets/js/honorarium/input.js') ?>"></script>
